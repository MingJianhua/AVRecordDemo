...
import com.android.tiange.encoder.CircularEncoder;
...
import java.nio.FloatBuffer;
 ...
 public class ContinuosEchoDisplay  implements SurfaceHolder.Callback,
     ...
     private static class MainHandler extends Handler implements CircularEncoder.Callback {
         ...
         private WeakReference<ContinuosEchoDisplay> mWeakActivity;

         public MainHandler(ContinuosEchoDisplay activity) {
             mWeakActivity = new WeakReference<ContinuosEchoDisplay>(activity);
         }
         ...
         public void handleMessage(Message msg) {
             ContinuosEchoDisplay activity = mWeakActivity.get();
             if (activity == null) {
     ...
     public  ContinuosEchoDisplay( Context  contex , SurfaceView  mHolder ) {
        ...
        mGLTextureBuffer.put(TextureRotationUtil.TEXTURE_NO_ROTATION).position(0);
    	 ...
    	 mBeautyFilter = new MagicBeautyFilter(contex);
   ...
   //      mOutputFile = new File( Environment.getExternalStorageDirectory() , "continuous-capture.mp4");
     ...
     public void surfaceCreated(SurfaceHolder holder) {
         ...
         int version = mEglCore.getGlVersion();
     ...
     private void drawFrame() {
         ...
         int newTextureId = mCameraInputFilter.onDrawToTexture(mTextureId);
         
//         mBeautyFilter.onDrawFrame(newTextureId ,mGLCubeBuffer, mGLTextureBuffer);
         
         mFullFrameBlit.drawFrame(newTextureId, mTmpMatrix);
