...
public class TextureMovieEncoder implements Runnable {
    ...
    private IVideoCallbak mOuputCallback;
    ...
    public TextureMovieEncoder( IVideoCallbak callback ){
    	mOuputCallback = callback;
    }
...
//        long timestamp = st.getTimestamp();
    ...
    public int getOutputFPS(){
    	if( mVideoEncoder != null ){
    		return mVideoEncoder.getOutputFPS();
    	}
    	return 0;
    }
    ...
    private void prepareEncoder(EGLContext sharedContext, int width, int height, int bitRate) {
        try {
            mVideoEncoder = new VideoEncoderCore(width, height, bitRate, mOuputCallback);
