...
public class Texture2dProgram {
    ...
    public enum ProgramType {
        TEXTURE_2D, TEXTURE_EXT, TEXTURE_EXT_BW, TEXTURE_EXT_FILT , TEXTURE_EXT_BEAUTY
    }

    public static final String NO_FILTER_VERTEX_SHADER1 = "" +
...
//	private int mSingleStepOffsetLocation;
    ...
    public Texture2dProgram(Context  mContext){
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        switch (programType) {
            ...
            case TEXTURE_EXT_BEAUTY:
            	mTextureTarget = GLES11Ext.GL_TEXTURE_EXTERNAL_OES;
            	mProgramHandle = OpenGLUtils.loadProgram("", "");//GlUtil.createProgram(VERTEX_SHADER, FRAGMENT_SHADER_EXT_FILT);
            	break;
            default:
...
//        GLES20.glUniform2fv(mSingleStepOffsetLocation, 1, FloatBuffer.wrap(new float[] {2.0f / width, 2.0f / height}));
    }
